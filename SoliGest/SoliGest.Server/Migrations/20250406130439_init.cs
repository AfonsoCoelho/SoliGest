        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartHoliday = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EndHoliday = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StatusClass = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResolutionDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AssistanceRequest_SolarPanel_SolarPanelId",
                        column: x => x.SolarPanelId,
                        principalTable: "SolarPanel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
